            ...
            <div>
                    <div class="wrapper fadeInDown">
                        <div id="formContent">
                          ...
                          <h2 @click.prevent="clickRegister"> Sign Up </h2>
                        ...
                        <div class="fadeIn first">
                          ...
                          <form id="login-form" @submit.prevent="trylogin">
                            <input type="text" id="login" class="fadeIn second" name="login" placeholder="email" v-model="emailLogin">
                            <input type="password" id="password" class="fadeIn third" name="login" placeholder="password" v-model="passwordLogin">
