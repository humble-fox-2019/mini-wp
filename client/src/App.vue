<template>
  <div id="one-for-all">
    ...
    <div v-if="landing" id="landing" style="height: 100vh;"
      class="d-flex align-items-center flex-column text-center justify-content-center px-2">
      <div>
    ...
    <div v-if="login" id="login" style="height: 100vh;"
      class="d-flex align-items-center flex-column justify-content-center px-2">
              ...
              <div class="card-body">
                <form id="login-form" name="login-form" action @submit.prevent="doLogin">
                  <div class="form-group">
                    ...
                    <input v-model="emailLogin" autofocus name="email" type="email" class="form-control"
                      id="login-email" aria-describedby="emailHelp" placeholder="Enter email">
                  </div>
                  <div class="form-group">
                    <label for="login-password">Password</label>
                    <input v-model="passwordLogin" name="password" type="password" class="form-control"
                ...
                <hr>
                <span>
                    No account ? <a @click.prevent="goRegister" id="linkregister" href="#"><b>Create an account</b></a>
                    to use Play Blog for
                    free!
                  </span>
                  <hr>
                  Or you can Sign In with your Google Account
                  <button v-google-signin-button="clientId" class="btn btn-sm"><i class="fab fa-google"></i>
                    Google</button>
              </div>
            </div>
          </div>
    ...
    <div v-if="register" id="register" style="height: 100vh;"
      class="d-flex align-items-center flex-column justify-content-center px-2">
      <!-- Login // id = "login-container" -->
      <div id="login-container" class="container">
        <div class="row">
              ...
              <div class="card-body">
                <form action @submit.prevent="doRegister()" id="register-form" name="register-form">
                  ...
                  <div class="form-group">
                    ...
                    <input v-model="passwordSignup" name="password" type="password" class="form-control"
                ...
                <div class="col-md-10 offset-md-1">
                  <form action="">
                    <div class="form-group">
                      ...
                      <input type="file" ref="file" v-on:change="handlefileupload($event)" class="form-control-file"
                        id="File1">
                    </div>
                    ...
                    <editor-menu-bar :editor="editor" v-slot="{ commands, isActive }">
                      <div class="menubar">
                        <button class="btn" :class="{ 'is-active': isActive.bold() }" @click.prevent="commands.bold">
                        ...
                        <button class="btn" :class="{ 'is-active': isActive.code() }" @click.prevent="commands.code">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      fetchArticles() {
        //fetch articles
        axios.get(`${SERVER_ADDRESS}/article`, {
            headers: {
